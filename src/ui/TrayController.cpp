...
TrayController::TrayController(QMainWindow* mainWindow)
    ...
    QAction* showAction = m_trayMenu->addAction(UiHelper::getIcon("monitor", QColor("#FFFFFF"), 18), "显示主界面");
    m_trayMenu->addSeparator();
    QAction* quitAction = m_trayMenu->addAction(UiHelper::getIcon("close", QColor("#FFFFFF"), 18), "退出 QuarkMeta");
