...
void ContentHeaderWidget::initUi() {
    ...
    m_iconLabel->setPixmap(UiHelper::getIcon("image_picture", QColor("#FFFFFF"), 18).pixmap(18, 18));
    ...
    auto setupToggleBtn = [this](QPushButton*& btn, const QString& iconKey, const QColor& activeColor, bool defaultChecked, const QString& tooltip) {
        ...
        btn->setIcon(UiHelper::getIcon(iconKey, defaultChecked ? activeColor : QColor("#FFFFFF"), 16));
    ...
    connect(m_btnToggleHidden, &QPushButton::clicked, this, [this]() {
        ...
        m_btnToggleHidden->setIcon(UiHelper::getIcon("eye", m_filterState.showHidden ? QColor("#FFFFFF") : QColor("#000000"), 16));
    ...
    connect(m_btnToggleFolders, &QPushButton::clicked, this, [this]() {
        ...
        m_btnToggleFolders->setIcon(UiHelper::getIcon("folder_filled", m_filterState.showFolders ? QColor("#FFFFFF") : QColor("#000000"), 16));
        emit filterStateChanged(m_filterState);
    });
    ...
    connect(m_btnToggleFiles, &QPushButton::clicked, this, [this]() {
        ...
        m_btnToggleFiles->setIcon(UiHelper::getIcon("file", m_filterState.showFiles ? QColor("#FFFFFF") : QColor("#000000"), 16));
        emit filterStateChanged(m_filterState);
    });
    ...
    m_btnLayers->setIcon(UiHelper::getIcon("layers", QColor("#FFFFFF"), 18));
...
void ContentHeaderWidget::setFilterState(const FilterState& state) {
    ...
    if (m_btnToggleHidden) {
        ...
        m_btnToggleHidden->setIcon(UiHelper::getIcon("eye", state.showHidden ? QColor("#FFFFFF") : QColor("#000000"), 16));
    }
    if (m_btnToggleFolders) {
        m_btnToggleFolders->setChecked(state.showFolders);
        m_btnToggleFolders->setIcon(UiHelper::getIcon("folder_filled", state.showFolders ? QColor("#FFFFFF") : QColor("#000000"), 16));
    }
    if (m_btnToggleFiles) {
        m_btnToggleFiles->setChecked(state.showFiles);
        m_btnToggleFiles->setIcon(UiHelper::getIcon("file", state.showFiles ? QColor("#FFFFFF") : QColor("#000000"), 16));
    }
}
