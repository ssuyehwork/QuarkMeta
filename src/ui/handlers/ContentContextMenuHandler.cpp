...
void ContentContextMenuHandler::showContextMenu(QAbstractItemView* view, const QPoint& pos) {
    ...
    if (isTrashView) {
        ...
        switch (action) {
            case ContentPanel::ActionRestore: {
                QuarkMeta::TrashService::instance().restoreItems(m_panel->getSelectedTrashIds(), m_panel);
                break;
            }
            case ContentPanel::ActionCut: {
                QuarkMeta::ClipboardService::instance().cutItems(m_panel->getSelectedPaths());
                break;
            }
            case ContentPanel::ActionSecureDelete: {
                QuarkMeta::PermanentDeleteService::instance().execute(m_panel->getSelectedPaths(), m_panel);
                break;
            }
            case ContentPanel::ActionRestoreAll: {
                QuarkMeta::TrashService::instance().restoreAll(m_panel);
                break;
            }
            case ContentPanel::ActionEmptyTrash: {
                QuarkMeta::TrashService::instance().emptyTrash(m_panel);
                break;
            }
            default:
                break;
    ...
    switch (action) {
        ...
        case ContentPanel::ActionCopy: {
            QuarkMeta::ClipboardService::instance().copyItems(m_panel->getSelectedPaths());
            break;
        }
        case ContentPanel::ActionCut: {
            QuarkMeta::ClipboardService::instance().cutItems(m_panel->getSelectedPaths());
        ...
        case ContentPanel::ActionPaste: {
            QuarkMeta::ClipboardService::instance().executePaste(isFolder ? path : currentPath, m_panel);
            break;
        }
        ...
        case ContentPanel::ActionDelete: {
            QuarkMeta::TrashService::instance().moveToTrash(m_panel->getSelectedPaths(), m_panel);
            break;
        }
        case ContentPanel::ActionSecureDelete: {
            QuarkMeta::PermanentDeleteService::instance().execute(m_panel->getSelectedPaths(), m_panel);
