...
void QuickLookWindow::showContextMenu(const QPoint& globalPos) {
    ...
    // 14 项选项
    QAction* actPrev = menu.addAction(UiHelper::getIcon("chevron_left", QColor("#FFFFFF"), 18), "上一个");
    ...
    QAction* actFit = menu.addAction(UiHelper::getIcon("split_v", QColor("#FFFFFF"), 18), "自适应");
